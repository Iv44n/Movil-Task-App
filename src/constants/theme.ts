...
const spacingBase = [3, 5, 7, 9, 11, 13, 15, 17, 21, 71] as const
const widthBase = [5, 31, 33, 47, 57, 99, 131, 191, 225, 355] as const
const heightBase = [5, 31, 33, 47, 57, 99, 131, 191, 255, 355] as const
